...
1) Welcome to GunFun ----------------------------------------------------------------------------------------------------- [3](#WelcomeToGunFun)  
 1.1) What is GunFun? --------------------------------------------------------------------------------------------- [3](#WhatIsGunFun)  
 1.2) Controls --------------------------------------------------------------------------------------------------------- [3](#Controls)  
 1.3) How to install/compile -------------------------------------------------------------------------------------- [3](#HowToInstall)  
 1.4) Assets ----------------------------------------------------------------------------------------------------------- [3](#Assets)

2) Steering Algorithms ------------------------------------------------------------------------------------------------------- [4](#SteeringAlgorithms)  
 2.1) Seek -------------------------------------------------------------------------------------------------------------- [4](#Seek)  
 2.2) Separation ----------------------------------------------------------------------------------------------------- [5](#Separation)  
 2.2) Flock ------------------------------------------------------------------------------------------------------------- [6](#ComplexSteering)

3) Other Algorithms ---------------------------------------------------------------------------------------------------------- [7](#OtherAlgorithms)  
 3.1) Shoot ------------------------------------------------------------------------------------------------------------ [7](#Shooting)

4) Bugs --------------------------------------------------------------------------------------------------------------------------- [8](#Bugs)  
 4.1) Gun Rotation ------------------------------------------------------------------------------------------------- [8](#GunRotation)  
 4.2) Laser Rotation ------------------------------------------------------------------------------------------------- [8](#LaserRotation)  
 4.3) Lag ---------------------------------------------------------------------------------------------------------------- [8](#Lag)
